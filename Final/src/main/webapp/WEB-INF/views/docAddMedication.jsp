...
<html>
<head>
<title>Healthy Home - Add Medication</title>
...
<body>
	...
	<div class="content">
		...
		<!-- orders table -->
		<form method="post" action="addToMedication">
		<div class="table-wrapper orders-table section">
				...
				<table class="table table-hover">
					<thead>
						...
						<th class="span2">Drug ID</th>
							<th class="span2">Drug Name</th>
							<th class="span3">Code</th>
							<th class="span3"><span class="line"></span> Brand</th>
					...
					<tbody>
					<c:forEach var="selectedDrug" items="${selectedDrug }">
					
						<!-- row -->
						<tr class="first">
						
					        <td><input type="text" style="width:50px" readonly="readonly" name="drugID" value="${selectedDrug.drug.drugID }"/></td>
							<td>${selectedDrug.drug.drugname }</td>
							<td>${selectedDrug.drug.code }</td>
							<td>${selectedDrug.drug.brand }</td>
							<td>${selectedDrug.drug.price }</td>
							
							<td>
												<div class="field-box">
													<label>Select quantity:</label> <select name="amount"
														style="width: 250px" class="select2" >

														<option />
														<c:forEach var="amount" items="${amount }">
															<option value="${amount.amount }" />${amount.amount }
                                                    </c:forEach>
													</select>
												</div>
			...
			<div class="pull-right">
					...
					<button  type="submit" class="btn-flat primary new-product">Make
						Medication</button>
