...
<html>
<head>
	<title>Healthy Home - Doctor Home</title>
        ...
        <div class="navbar-inner">
            ...
            <ul class="nav pull-right">                
                ...
                <li class="settings hidden-phone">
                    <a href="showDoctorInfor" role="button">
                        <i class="icon-cog"></i>
                    </a>
                </li>
                <li class="settings hidden-phone">
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="user/showPatient">Patient List</a></li>
                    
                </ul>
            </li>
            <li>
                <a href="user/patientAppointmentList">
                            ...
                            <c:forEach var="appoints" items="${appoints}">
                                ...
                                <tr class="first">
                                    <td>
                                        ...
                                        <a href="user/docViewDetailOfAppointment?appointID=${appoints.appId }" class="name">${appoints.appId } </a>
                                    </td>
