	...
	<div class="content">
		...
		<div class="container-fluid">
			<div id="pad-wrapper">
					...
					<form action="docMakeMedication" method="post">
					<div class="table-wrapper products-table section">
						...
						<div class="row-fluid">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										<th class="span3">Drug ID</th>
										<th class="span3"><span class="line"></span>Name</th>
										<th class="span3"><span class="line"></span>Code</th>
									...
									<c:forEach var="drugs" items="${drugs }">
										...
										<tr class="first">
											<td><input type="checkbox" name="drugID"
												value="${drugs.drugID }" /> <a
												href="showDrugDetails?drugId=${drugs.drugID }" class="name">${drugs.drugID }</a>
											</td>
											<td class="description">${drugs.drugname }</td>
											<td class="description">${drugs.code }</td>
											<td class="description">${drugs.brand }</td>
						...
						<div class="pull-right">
							<button type="submit" id="addDrug"
								class="btn-flat primary new-product">+ Add to
								Medication</button>
						</div>
						</div>
						</form>
