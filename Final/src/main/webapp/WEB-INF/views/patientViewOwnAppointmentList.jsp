...
<html>
<head>
	<title>Healthy Home - Appointment List</title>
            ...
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper orders-table section">
                    ...
                    <div class="row-fluid">
                        <table class="table table-hover">
                            ...
                            <c:forEach var="appoints" items="${appoints }">
                                ...
                                <tr class="first">
                                    <td>
                                        <a href="patientViewDetailsOfAppointment?appointID=${appoints.appId }"># ${appoints.appId }</a>
                                    </td>
                                    <td>
                                        ${appoints.makeTime }
                                    </td>
                                    <td>
                                        <a href="patientViewDoctorDetails?docname=${appoints.docname}">${appoints.docname}</a>
                                    </td>
                                    <td>
                                        ${appoints.docCode }
                                    </td>
                                    ...
                                    <td>
                                        <span class="label label-success">${appoints.status }</span>
                                    </td>  
                                </tr>
                    ...
                    <div class="pull-right">
                        <a class="btn-flat success " href="showDoctors">+ Add New Appointment</a>
                        </div>
                </div>
                <!-- end orders table -->
