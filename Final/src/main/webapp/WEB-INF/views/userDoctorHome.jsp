				...
				<table class="table table-hover">
					<thead>
						<tr>
							<th class="span3">
								Appointment ID</th>
							<th class="span3"><span class="line"></span>Appointment Date
							</th>
							<th class="span3"><span class="line"></span>Patient Name</th>
							<th class="span3"><span class="line"></span>Type of Disease
							</th>
						
						</tr>
					</thead>
					<tbody>
						<c:forEach var="appoints" items="${appoints}">
							<!-- row -->
							<tr class="first">
								<td> <a
									href="docViewDetailOfAppointment?appointID=${appoints.appId }"
									class="name">${appoints.appId } </a></td>
								<td class="description">${appoints.appointDate }</td>
								<td class="description">${appoints.paname }</td>
								<td class="description">${appoints.typeOfDisea }</td>
