                ...
                <div class="table-products section">
                    ...
                    <div class="row-fluid filter-block">
                        <div class="pull-right">
                            ...
                            <a class="btn-flat new-product" href="showDoctors">Find More</a>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="first">
                                    <td>
                                        <a href="makeAppointment?docName=${docList.docUsername }&docCode=${docList.docCode}">${docList.docUsername } </a>
                                    </td>
